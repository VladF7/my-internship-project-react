...
import { INumberOfOrdersByCity, MIN_MAX_DATE } from '../../../../types/statistic.types'

Chart.register(CategoryScale)

const OrdersByCityChart: FC = () => {
  const { timezone } = useAppSelector((state) => state.timezone)
  const [chartData, setChartData] = useState<INumberOfOrdersByCity[]>([])
